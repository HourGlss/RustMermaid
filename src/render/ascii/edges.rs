...
///
/// If the ideal position overlaps occupied cells (entity boxes), the label
/// is shifted to nearby rows/columns to find a fully clear placement. This
/// prevents label truncation (e.g., "contains" appearing as "conta").
